...
@endif
<form method="POST" action="{{ url('mtbs') }}">
@csrf
<div class="card card-custom mb-5">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-9">
                <select name="no_rm" id="select-rm" class="form-control @error('no_rm') is-invalid @endif">
                    <option value=""></option>
                    @foreach ($users as $s)
                        <option @if(old('no_rm') == $s->no_rm) selected @endif value="{{ $s->no_rm }}">{{ $s->name }}</option>
                    @endforeach
                </select>
                @error('no_rm')
        ...
        <div class="form-group row">
            ...
            <div class="col-9">
                <input type="text" value="{{ old('nama_anak') }}" class="form-control @error('nama_anak') is-invalid @endif" name="nama_anak" placeholder="Nama anak yang berobat">
                @error('nama_anak')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-5">
                ...
                <select name="kunjungan_pertama" id="" class="form-control">
                    <option @if(old('kunjungan_pertama') == 0) selected @endif value="0">Tidak</option>
                    <option @if(old('kunjungan_pertama') == 1) selected @endif value="1">Iya</option>
                </select>
            ...
            <div class="col-4">
                ...
                <select name="kunjungan_ulang" id="" class="form-control">
                    <option @if(old('kunjungan_ulang') == 0) selected @endif value="0">Tidak</option>
                    <option @if(old('kunjungan_ulang') == 1) selected @endif value="1">Iya</option>
                </select>
...
<div class="card card-custom mb-5">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-9">
                <textarea class="form-control @error('keluhan') is-invalid @endif" name="keluhan" placeholder="Ketikan seluruh keluhan yang pasien berikan">{{ old('keluhan') }}</textarea>
                @error('keluhan')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-9">
                <select class="form-control @error('tanda_bahaya') is-invalid @enderror" name="tanda_bahaya[]" multiple id="select-tanda-bahaya">
                    ...
                    <option {{ (collect(old('tanda_bahaya'))->contains("Memuntahkan semuanya")) ? 'selected':'' }} value="Memuntahkan semuanya">Memuntahkan semuanya</option>
                    <option {{ (collect(old('tanda_bahaya'))->contains("Kejang")) ? 'selected':'' }} value="Kejang">Kejang</option>
                    <option {{ (collect(old('tanda_bahaya'))->contains("Letangis atau Tidak sadarx")) ? 'selected':'' }} value="Letangis atau Tidak sadar">Letangis atau Tidak sadar</option>
                </select>
                @error('tanda_bahaya')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
        ...
        <div class="form-group row">
            ...
            <div class="col-4">
                ...
                <select name="batuk" id="" class="form-control @error('batuk') is-invalid @enderror">
                    <option @if(old('batuk') == 0) selected @endif value="0">Tidak</option>
                    <option @if(old('batuk') == 1) selected @endif value="1">Iya</option>
                </select>
                @error('batuk')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="col-5">
                ...
                <input type="number" name="batuk_lama" class="form-control @error('batuk_lama') is-invalid @enderror" value="{{ old('batuk_lama') }}">
                @error('batuk_lama')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-3">
                ...
                <select name="demam" id="" class="form-control @error('demam') is-invalid @enderror">
                    <option @if(old('demam') == 0) selected @endif value="0">Tidak</option>
                    <option @if(old('demam') == 1) selected @endif value="1">Iya</option>
                </select>
                @error('demam')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="col-3">
                ...
                <input type="number" class="form-control @error('demam_lama') is-invalid @enderror" name="demam_lama" value="{{ old('demam_lama') }}">
                @error('demam_lama')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="col-3">
                ...
                <select name="demam_tiap_hari" id="" class="form-control @error('demam_tiap_hari') is-invalid @enderror">
                    <option @if(old('demam_tiap_hari') == 0) selected @endif value="0">Tidak</option>
                    <option @if(old('demam_tiap_hari') == 1) selected @endif value="1">Iya</option>
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-3">
                ...
                <select name="diare" id="" class="form-control @error('diare') is-invalid @enderror">
                    <option @if(old('diare') == 0) selected @endif value="0">Tidak</option>
                    <option @if(old('diare') == 1) selected @endif value="1">Iya</option>
                </select>
                @error('demam')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="col-3">
                ...
                <input type="number" class="form-control @error('diare_lama') is-invalid @enderror" name="diare_lama" value="{{ old('diare_lama') }}">
                @error('diare_lama')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="col-3">
                ...
                <select name="darah_demam" id="" class="form-control @error('darah_demam') is-invalid @enderror">
                    <option @if(old('darah_demam') == 0) selected @endif value="0">Tidak</option>
                    <option @if(old('darah_demam') == 1) selected @endif value="1">Iya</option>
                </select>
                @error('darah_demam')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
...
<div class="card card-custom">
    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-9">
                <select name="klasifikasi_bahaya_umum" id="" class="form-control @error('klasifikasi_bahaya_umum') is-invalid @enderror">
                    ...
                    <option @if(old('klasifikasi_bahaya_umum') == 1) selected @endif value="1">Iya</option>
                </select>
                @error('tanda_bahaya')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
        ...
        <div class="form-group row">
            ...
            <div class="col-9">
                <textarea class="form-control @error('tindakan_bahaya_umum') is-invalid @endif" name="tindakan_bahaya_umum" placeholder="Tindakan terhadap tanda - tanda bahaya umum">{{ old('tindakan_bahaya_umum') }}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-9">
                <textarea class="form-control @error('hasil_rdt') is-invalid @endif" name="hasil_rdt" placeholder="Hasil RDT">{{ old('hasil_rdt') }}</textarea>
                @error('hasil_rdt')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-9">
                <textarea class="form-control @error('hasil_sdm') is-invalid @endif" name="hasil_sdm" placeholder="Hasil SDM">{{ old('hasil_sdm') }}</textarea>
                @error('hasil_sdm')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
