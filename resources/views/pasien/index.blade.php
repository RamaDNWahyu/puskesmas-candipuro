    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Data Pasien
                <div class="text-muted pt-2 font-size-sm">Silahkan gunakan fitur pencarian untuk mencari pasien dengan cepat</div>
            </h3>
        </div>
        <div class="card-toolbar">
            ...
            <!--end::Dropdown-->
            <!--begin::Button-->
            <a href="{{ url('pasien/create') }}" class="btn btn-primary font-weight-bolder">
            <span class="svg-icon svg-icon-md">
    ...
    $(document).ready(function () {
        table = $('#datatable').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'nama_kk', name: 'nama_kk', orderable: true, searchable: true
                },
                {
